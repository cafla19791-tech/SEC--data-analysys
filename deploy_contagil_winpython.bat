...
copy /Y "%REPO%\scripts\discriminativos_diretas_ipca.py" "%WINPY%\scripts\" >nul
...
copy /Y "%REPO%\discriminativos_diretas_ipca.py" "%WINPY%\" >nul
...
copy /Y "%REPO%\discriminativos_diretas_ipca.bat" "%WINPY%\" >nul
