...
class SelicSerie:
    ...
    def from_excel(cls, path: Path) -> "SelicSerie":
        """Lê STP ContAgil: col 0 = data, col 3 = fator acumulado (fallback: última col)."""
    ...
    def from_bacen(
        ...
        if cache_path is not None:
            ...
            # Layout ContAgil: col0=data, col3=fator (cols 1–2 auxiliares)
            out = pd.DataFrame(
                {
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        default=None,
        help=(
            "Excel STP ContAgil/Bacen (col0=data, col3=fator). "
